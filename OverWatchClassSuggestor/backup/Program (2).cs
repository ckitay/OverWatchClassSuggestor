...
namespace OverWatchClassSuggestor
{
    ...
    public static class OverWatchClasses
    {
        ...
        public static Character classDoomfist = new Character(doomfist, offense,
            new string[] { ana, symmetra, torbjorn }, // Strong Against
            new string[] { orisa, sombra, mcCree }, // Weak Against
            new string[] {  } // Neutral
            );

        public static Character classGenji = new Character(genji, offense,
            new string[] { bastion, mercy, widowMaker, hanzo, zenyatta, soldier76 }, // Strong Against
            new string[] { zarya, mei, winston, roadhog, pharah, symmetra }, // Weak Against
            new string[] {  } // Neutral
            );

        public static Character classMcCree = new Character(mcCree, offense,
            new string[] { mercy, reaper, tracer, zenyatta, winston }, // Strong Against
            new string[] { genji, widowMaker, bastion, zarya, reinhardt}, // Weak Against
            new string[] {  } // Neutral
            );

        public static Character classPharah = new Character(pharah, offense,
            new string[] { junkrat, reaper, mei }, // Strong Against
            new string[] { soldier76, roadhog, widowMaker  }, // Weak Against
            new string[] {  } // Neutral
            );

        public static Character classReaper = new Character(reaper, offense,
            new string[] { winston, roadhog, reinhardt, mercy }, // Strong Against
            new string[] { mcCree, pharah, genji, zarya }, // Weak Against
            new string[] {  } // Neutral
            );

        public static Character classSoldier76 = new Character(soldier76, offense,
            new string[] { pharah, zenyatta, torbjorn, mercy, }, // Strong Against
            new string[] { genji, roadhog, mcCree, reinhardt, mei }, // Weak Against
            new string[] {  } // Neutral
            );

        public static Character classSombra = new Character(sombra, offense,
            new string[] { bastion, lucio, widowMaker, reinhardt, zarya}, // Strong Against
            new string[] { symmetra, mei, winston, roadhog, pharah }, // Weak Against
            new string[] { } // Neutral
            );
        ...
        public static Character classOrisa = new Character(orisa, tank,
            new string[] { winston, reinhardt, lucio, torbjorn, mercy, zenyatta }, // Strong Against
            new string[] { genji, tracer, reaper, sombra, widowMaker, bastion }, // Weak Against
            new string[] { } // Neutral
            );
